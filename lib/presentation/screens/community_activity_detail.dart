...
class CommunityActivityDetailPage extends StatelessWidget {
  ...
  const CommunityActivityDetailPage({super.key, required this.activity, required this.controller});
        ...
        body: ListView(
          ...
          children: [
            ...
            _infoRow(Icons.calendar_today,
                activity.eventDate != null ? _formatDate(activity.eventDate!) : 'TBA'),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: isFull && !activity.isRegistered ? null : () async {
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: activity.isRegistered ? Colors.white : Colors.black87,
